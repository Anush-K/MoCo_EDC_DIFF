...
def main_worker(gpu, args):
    ...
    print("\n================ FINAL EVALUATION METRICS - APTOS================\n")
    ...
    #     "results_test_edc_aptos.csv", index=False
    # )

    # pd.DataFrame(misclassified, columns=["S.No", "Filename", "GT", "Pred"]).to_csv(
    #     "misclassified_test_edc_aptos.csv", index=False
    # )

    # print("\nSaved results_test_edc_aptos.csv & misclassified_test_edc_aptos.csv\n")
