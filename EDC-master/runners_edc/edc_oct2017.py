...
def main_worker(gpu, args):
    ...
    best_thr = eval_dict['eval/best_thr']   # ⭐ ADD THIS
    logging.warning(f"Training and Evaluation are COMPLETED!")
    ...
    print("\n================ FINAL EVALUATION METRICS - OCT2017 ================\n")
    ...
    #     "results_test_edc_oct2017.csv", index=False
    # )

    # pd.DataFrame(misclassified, columns=["S.No", "Filename", "GT", "Pred"]).to_csv(
    #     "misclassified_test_edc_oct2017.csv", index=False
    # )

    # print("\nSaved results_test_edc_oct2017.csv & misclassified_test_edc_oct2017.csv\n")
