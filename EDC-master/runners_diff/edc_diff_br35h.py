...
def main_worker(gpu, args):
    ...
    # mis_dir = "misclassified_br35h_diff"
    ...
    #     "results_test_edc_diff_br35h.csv", index=False
    # )

    # pd.DataFrame(misclassified, columns=["S.No", "Filename", "GT", "Pred"]).to_csv(
    #     "misclassified_test_edc_diff_br35h.csv", index=False
    # )

    # print("\nSaved results_test_edc_diff_br35h.csv & misclassified_test_edc_diff_br35h.csv\n")
