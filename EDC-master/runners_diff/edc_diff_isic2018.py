...
def main_worker(gpu, args):
    ...
    # mis_dir = "misclassified_isic2018_diff"
    ...
    #     "results_test_edc_diff_isic2018.csv", index=False
    # )

    # pd.DataFrame(misclassified, columns=["S.No", "Filename", "GT", "Pred"]).to_csv(
    #     "misclassified_test_edc_diff_isic2018.csv", index=False
    # )

    # print("\nSaved results_test_edc_diff_isic2018.csv & misclassified_test_edc_diff_isic2018.csv\n")
