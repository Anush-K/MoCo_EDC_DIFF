...
import warnings
from configs.config_aptos import DATASET_DIR, TEST_DIR
...
def main_worker(gpu, args):
    ...
    # # ======================================================================
    # # APTOS: SAVE CSVs + FULL MISCLASSIFICATION SUMMARY
    # # ======================================================================

    # test_dir = os.path.join(args.data_dir, "test")
    # label_map = {0: "NORMAL", 1: "ABNORMAL"}

    # mis_dir = "misclassified_aptos_diff"
    ...
    #     "results_test_edc_diff_aptos.csv", index=False
    # )

    # pd.DataFrame(misclassified, columns=["S.No", "Filename", "GT", "Pred"]).to_csv(
    #     "misclassified_test_edc_diff_aptos.csv", index=False
    # )

    # print("\nSaved results_test_edc_diff_aptos.csv & misclassified_test_edc_diff_aptos.csv\n")
